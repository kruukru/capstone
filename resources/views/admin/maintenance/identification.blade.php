...
@section('content')
    <section class="content-header">
		<h1>Maintenance - Identification</h1>
	</section>
		...
		<div class="row">
			<div class="container col-sm-12">
				<div class="box box-primary">
					...
					<button id="btnNew" class="btn btn-primary btn-md">New Identification</button><hr>
						<table id="tblIdentification" class="table table-striped table-bordered">
							<thead>
								<th>Question</th>
								<th>Answer</th>
	...
	<div class="modal fade" id="modalIdentification">
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="formIdentification" data-parsley-validate>
					<!-- modal header -->
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="inputChoice" required>
						</div>
					</div>
					<!-- modal footer -->
	...
	<!-- modal for remove -->
	<div class="modal fade" id="modalIdentificationRemove">
		<div class="modal-dialog">
			<div class="modal-content">
				<!-- modal header -->
				<div class="modal-header">
...
@section('script')
	<script src="/js/custom/admin/maintenance/identification.js"></script>
@endsection