...
@section('content')
							...
							<tbody id="applicant-list">
								...
								<tr id="id{{$applicant->applicantid}}">
									...
									<td style="text-align: center;">
										...
										@if ($applicant->status == 0 && $applicant->appointment == null)
											<button class="btn btn-danger btn-xs" id="btnRemove" value="{{$applicant->applicantid}}">Remove</button>
										@endif
									</td>
								</tr>
								@endforeach
		                    	...
		                    	<div class="box box-primary">
		                    		<div class="box-body">
		                    			<form id="formIDs" data-parsley-validate>
			                        		...
			                        		<div class="col-md-offset-1">
			                        			<h3>APPLICANT REQUIREMENT</h3>
			                        		</div>
			                        		<div class="form-group table-responsive">
								            	<table class="table table-striped table-bordered" id="tblApplicantRequirement">
													<thead>
														<th>Requirement</th>
														<th>Remarks</th>
														<th>Submitted</th>
													</thead>
													<tbody id="applicantrequirement-list"></tbody>
												</table>
								            </div>
			                        		<div class="form-group">
	...
	<div class="modal fade" id="modalRemoveSecurityGuard">
