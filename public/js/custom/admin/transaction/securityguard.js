$(document).ready(function() {
    ...
    var tableApplicantRequirement = $('#tblApplicantRequirement').DataTable({
        "aoColumns": [
            null,
            null,
            null,
    ...
    $('#applicant-list').on('click', '#btnRemove', function() {
        applicantid = $(this).val();

        $('#modalRemoveSecurityGuard').modal('show');
    });
    $('#btnRemoveConfirm').click(function(e) {
        ...
        $('#modalRemoveSecurityGuard').loading({
            message: "SAVING..."
        });

        $.ajax({
            type: "POST",
            url: "/admin/transaction/securityguard/remove",
            ...
            success: function(data) {
                ...
                $('#modalRemoveSecurityGuard').modal('hide');
                $('#modalRemoveSecurityGuard').loading('stop');
    ...
    $('#applicant-list').on('click', '#btnProfile', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "GET",
            url: "/json/applicant/requirement",
            data: { inputApplicantID: applicantid },
            dataType: "json",
            success: function(data) {
                console.log(data);
                ...
                $.each(data, function(index, value) {
                    ...
                    var row = "<tr>" +
                        ...
                        "<td>" + value.remarks + "</td>" +
                        "<td>" + value.issubmitted + "</td>" +
                        "</tr>";
                    tableApplicantRequirement.row.add($(row)[0]).draw();
                });
            },
        });
